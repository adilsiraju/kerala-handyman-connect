      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#home" className="text-kerala-charcoal hover:text-kerala-green transition-colors">Home</a>
            <a href="#services" className="text-kerala-charcoal hover:text-kerala-green transition-colors">Services</a>
            <a href="#about" className="text-kerala-charcoal hover:text-kerala-green transition-colors">About</a>
            <a href="#contact" className="text-kerala-charcoal hover:text-kerala-green transition-colors">Contact</a>
            <a href="#partner" className="text-kerala-charcoal hover:text-kerala-green transition-colors">Join as Partner</a>
          </div>
